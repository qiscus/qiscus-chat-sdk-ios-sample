...
class UIChatInput2: UIView {
    
    @IBOutlet weak var btnAttachment: UIButton!
    @IBOutlet weak var btnSend: UIButton!
    @IBOutlet weak var tfInput: UITextField!
    var delegate : UIChatInputDelegate2? {
        set {
    ...
    private var _delegate       : UIChatInputDelegate2? = nil
...
extension UIChatInput2 : UIChatInputAction2 {
    func setHeight(_ value: CGFloat) {
