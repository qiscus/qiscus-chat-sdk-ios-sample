...
class PerformanceAgentVC: UIViewController, IndicatorInfoProvider, UIWebViewDelegate, WKNavigationDelegate {
    var agentId : Int = 0
...
//    }
    ...
    func getURL(){
        ...
        Alamofire.request("\(QiscusHelper.getBaseURL())/api/v1/agent_analytics", method: .get, parameters: param, headers: header as! HTTPHeaders).responseJSON { (response) in
