...
class RoomInfoVC: UIViewController {
    ...
    func setupUI(){
        ...
        self.tableView.register(UINib(nibName: "ContactCell", bundle: MyChat.bundle), forCellReuseIdentifier: "ContactCellIdentifire")
        ...
        ivIconAddParticipant.image = UIImage().image(named: "ic_add_participants")?.withRenderingMode(.alwaysTemplate)
        
        btIconAvatar.setImage(UIImage().image(named: "ic_image_attachment")?.withRenderingMode(.alwaysTemplate), for: .normal)
        btIconEditName.setImage(UIImage().image(named: "ic_edit")?.withRenderingMode(.alwaysTemplate), for: .normal)
...
extension RoomInfoVC: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let image = UIImage().image(named: "ar_cancel")?.withRenderingMode(UIImage.RenderingMode.alwaysTemplate)
