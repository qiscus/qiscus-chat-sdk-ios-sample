...
class QFileRightCell: UIBaseChatCell {
    ...
    func bindData(message: CommentModel){
        ...
        self.ivFIle.image = UIImage().image(named: "ic_file_attachment")?.withRenderingMode(.alwaysTemplate)
    ...
    func status(message: CommentModel){
        ...
        case .deleted:
            ivStatus.image = UIImage().image(named: "ic_deleted")?.withRenderingMode(.alwaysTemplate)
            break
        case .sending, .pending:
            ...
            ivStatus.image = UIImage().image(named: "ic_info_time")?.withRenderingMode(.alwaysTemplate)
            break
        case .sent:
            lbTime.textColor = ColorConfiguration.timeLabelTextColor
            ivStatus.tintColor = ColorConfiguration.readMessageColor
            ivStatus.image = UIImage().image(named: "ic_sending")?.withRenderingMode(.alwaysTemplate)
            break
        case .delivered:
            lbTime.textColor = ColorConfiguration.timeLabelTextColor
            ivStatus.tintColor = ColorConfiguration.readMessageColor
            ivStatus.image = UIImage().image(named: "ic_read")?.withRenderingMode(.alwaysTemplate)
            break
        case .read:
            lbTime.textColor = ColorConfiguration.timeLabelTextColor
            ivStatus.tintColor = ColorConfiguration.readMessageColor
        ...
        case . failed:
            ...
            ivStatus.image = UIImage().image(named: "ic_warning")?.withRenderingMode(.alwaysTemplate)
