...
class CreateGroupInfoVC: UIViewController, UITextFieldDelegate {
    ...
    private func setupUI() {
        ...
        self.iconAvatarGroup.image = UIImage().image(named: "ic_image_attachment")?.withRenderingMode(.alwaysTemplate)
    ...
    private func nextButton(_ target: UIViewController, action: Selector) -> UIBarButtonItem{
        ...
        let image = UIImage().image(named: "ic_next")?.withRenderingMode(UIImage.RenderingMode.alwaysTemplate)
...
extension CreateGroupInfoVC: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.ivCheck.image = UIImage().image(named: "ic_cancel")?.withRenderingMode(.alwaysTemplate)
        ...
        if fileType == "public.image"{
            ...
            if data != nil {
                ...
                QiscusCore.shared.upload(data: data!, filename: imageName, onSuccess: { (fileURL) in
                    ...
                    self.iconAvatarGroup.isHidden = false
                    self.profileImageView.image = UIImage().image(named: "ic_avatar_group")!
