...
class CreateNewGroupVC: UIViewController {
    ...
    private func setupUI() {
        ...
        collectionView.register(UINib(nibName: "ContactSelectCollCell", bundle: MyChat.bundle), forCellWithReuseIdentifier: "ContactCollectionIdentifier")
...
extension CreateNewGroupVC: UICollectionViewDelegateFlowLayout, UICollectionViewDataSource{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let placeHolderImage: UIImage   = UIImage().image(named: "avatar")!
        ...
        let iconImage                       = UIImage().image(named: "ar_cancel")!
