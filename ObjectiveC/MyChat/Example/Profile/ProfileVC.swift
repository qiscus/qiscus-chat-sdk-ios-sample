...
class ProfileVC: UIViewController {
    ...
    func setupUI(){
        ...
        ivIconLogout.image = UIImage().image(named: "ic_logout")?.withRenderingMode(.alwaysTemplate)
        ivIconUniqueID.image = UIImage().image(named: "ic_id")?.withRenderingMode(.alwaysTemplate)
        ivIconName.image = UIImage().image(named: "ic_contact")?.withRenderingMode(.alwaysTemplate)
